  ...
  public void initialize(CordovaInterface cordova, CordovaWebView webView) {
    ...
    if (Build.VERSION.SDK_INT >= 23) {
      if (mainActivity.checkSelfPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
        this.waitingForPermission = 1;
        cordova.requestPermission(this, MY_PERMISSIONS_REQUEST_WRITE_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE);
